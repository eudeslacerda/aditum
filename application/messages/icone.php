...
return array(
    'usuario' => array(
        'novo' => '<svg class="bi bi-person-plus-fill float-left" width="2em" height="2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        'lista' => '<svg class="bi bi-person-lines-fill float-left" width="2em" height="2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
